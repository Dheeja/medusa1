...
In Medusa v2, you use Medusa's Data Modeling Language (DML) to create data models. It simplifies defining a table's columns, relations, and indexes with straightforward methods and configurations.
...
In Medusa v1, you imported all Workflow SDK functions and types from the `@medusajs/workflows-sdk` package.
...
Medusa also provides [Medusa Cloud](https://medusajs.com/cloud/), which is our managed services offering that makes deploying and operating Medusa applications possible without having to worry about configuring, scaling, and maintaining infrastructure.
