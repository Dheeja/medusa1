...
The index module only ingests data when you start your Medusa server. So, to injest the [currently supported data models](#injested-data-models), start the Medusa application:
